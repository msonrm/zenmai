...
| | いま |
|---|---|
| 訳文 | 完全一致 1,109 / テンプレート 147 / 完成行 170 / 名前 336 / 語訳 443 / ふりがな 275 |
| 在庫 | 1,803 件 = 訳あり 1,592 / 完成行に吸収 166 / 訳さない 45 —— ★**未解決 0** |
| 入力 | 前置詞 18 / 動詞 126 / 物 134 —— 日本語の言い方は延べ **1,125** |
| 打ち方 | キーボード / ゲームパッド / スマホのフリック（★**op の語彙が同じなので配線は 1 本**） |
| 検査 | **7 本**（`test/run-*.js`）—— 入力の固定表 51 件・通しの日本語・walkthrough の未訳ログ・Glk シム・セーブ復帰・ブラウザホストの配線・ZVM ハーネス |
